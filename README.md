...
- **Customization** — default playback speed, player status bar toggle, home section visibility, startup preload
- **Visual style** — dark gradient background, brand-purple glow, frosted cards, edge-to-edge status bar
